...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2271.3358333564743; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1794.0850367545183; // x position of the perpendicular encoder (in tick units)
    }
